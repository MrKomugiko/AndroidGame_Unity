...
namespace Codice.Views.CreateWorkspace.Dialogs
{
    ...
    internal class RepositoriesListHeaderState : MultiColumnHeaderState, ISerializationCallbackReceiver
    {
                ...
                var headerState = new RepositoriesListHeaderState(new Column[]
                {
                    new Column()
                    {
                        ...
                        headerContent = new GUIContent(
                            GetHeaderContent(RepositoriesListColumn.Name)),
                        minWidth = 200,
                    ...
                    new Column()
                    {
                        width = 200,
                        headerContent = new GUIContent(
                            GetHeaderContent(RepositoriesListColumn.Server)),
                        minWidth = 200,
                        allowToggleVisibility = false,
                    }
                });
        ...
        internal static string GetHeaderContent(RepositoriesListColumn column)
        {
            switch (column)
            {
