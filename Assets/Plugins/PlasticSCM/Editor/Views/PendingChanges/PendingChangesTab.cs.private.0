...
namespace Codice.Views.PendingChanges
{
        ...
        PendingChangesOptionsDialog.IAutorefreshView
    {
        ...
        static bool DoOperationButton(string buttonText)
        {
            GUIContent buttonContent = new GUIContent(buttonText);
            GUIStyle buttonStyle = EditorStyles.miniButton;

            Rect rect = GUILayoutUtility.GetRect(buttonContent, buttonStyle);

            return GUI.Button(rect, buttonText, buttonStyle);
        }
        ...
        static void DoSearchField(SearchField searchField,
            PendingChangesTreeView changesTreeView,
            float width)
        {
            ...
            changesTreeView.searchString = searchField.OnToolbarGUI(
                searchFieldRect, changesTreeView.searchString);

            if (string.IsNullOrEmpty(changesTreeView.searchString))
