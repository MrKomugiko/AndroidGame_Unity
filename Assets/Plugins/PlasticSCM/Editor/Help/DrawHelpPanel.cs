    ...
    internal static class DrawHelpPanel
    {
            ...
            HelpPanel helpPanel)
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                {
                    // TO DO(codice): On Left Clicked
                }

                if (GUILayout.Button(">", EditorStyles.miniButtonRight))
                {
                    // TO DO(codice): On Right Clicked
                }

                GUILayout.FlexibleSpace();

                // TO DO(codice): The bool used here must be loaded and persisted by some means
                ...
                {
                    helpPanel.Hide();
                    // TO DO(codice): Do on helppanel dismiss actions
                    return;
                }
            }
        }
